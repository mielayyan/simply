...
class url_scripts_model extends inf_model {
    ...
    public function getURLScripts($url_id) {
        ...
        if ($url_id == 22) {
            ...
            $script_arr[10]['name'] = "filepond/filepond.min.js";
            $script_arr[10]['type'] = "plugins/js";
            $script_arr[10]['loc'] = "footer";
                
            $script_arr[11]['name'] = "filepond/filepond-plugin-image-preview.min.js";
            $script_arr[11]['type'] = "plugins/js";
            $script_arr[11]['loc'] = "footer";

            $script_arr[13]['name'] = "toastr/jquery.toast.min.js";
            $script_arr[13]['type'] = "js";
            $script_arr[13]['loc'] = "footer";

            $script_arr[14]['name'] = "profile_update.js";
        ...
        if ($url_id == 276  || $url_id == 277 || $url_id == 281) {
        ...
        if ($url_id == 289) {
            $script_arr[1]['name'] = "validate_edit_sms_content.js";
            $script_arr[1]['type'] = "js";
            $script_arr[1]['loc'] = "footer";
        }
