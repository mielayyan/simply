...
class feedback extends Inf_Controller {
	...
	$this->form_validation->set_rules('company', lang('company'), 'trim|required|min_length[3]|max_length[250]|strip_tags',[
       "required"=>lang('required'),
       "max_length"=>sprintf(lang('maxlength'),lang('company'),"250"),
       "minlength"=>sprintf(lang('minlength'),lang('company'),"3")
	]);
	$this->form_validation->set_rules('phone_no', lang('phone_no'), 'trim|required|is_natural|min_length[5]|max_length[30]',[
      "required"=>lang('required'),
      "max_length"=>sprintf(lang('maxlength'),lang('phone_no'),"30"),
      "minlength"=>sprintf(lang('minlength'),lang('phone_no'),"5"),
       "is_natural"=>lang('digits')


	]);
	$this->form_validation->set_rules('time_to_call', lang('time_to_call'), 'trim|required|valid_time',[
       "required"=>sprintf(lang('required_select'),lang('time_to_call')),
       "valid_time"=>lang('suitable_time')
	...
	$this->form_validation->set_rules('comments', lang('comments'), 'trim|required|max_length[1000]',[

		"required"=>lang('required'),
		"max_length"=>sprintf(lang('maxlength'),lang('comments'),"1000"),
