...
class Lcp extends Core_Inf_Controller {
    ...
    public function validate_lead() {
        $this->lang->load('validation', $this->session->userdata('lcp_language')['lang_name_in_english']);
        $this->lang->load('lcp', $this->session->userdata('lcp_language')['lang_name_in_english']);
