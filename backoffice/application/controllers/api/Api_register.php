...
class api_register extends Inf_Controller
{
    ...
    function register_get()
    {
        ...
        $this->load->model('product_model');
        //reegitser from tree
        $placement_user_name = $this->get('username') ?? '';
        ...
        $sponsorField = [
            [
                ...
                'required'  => true,
                'value'     => $this->validation_model->IdToUserName($this->LOG_USER_ID),
                'isEditable' => false,
                'type'      => 'text',
            ...
            [
                ...
                'required'  => false,
                'value'     => $this->register_model->getReferralName($this->LOG_USER_ID),
                'isEditable' => false,
                'type'      => 'text',
