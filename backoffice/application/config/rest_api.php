...
$config['auth_override_class_method']['auth']['api_key'] = 'none';
$config['auth_override_class_method']['demo']['demo_credentials'] = 'none';
$config['auth_override_class_method']['demo']['api_key'] = 'none';
$config['auth_override_class_method']['demo']['admin_username'] = 'none';
$config['auth_override_class_method']['auth']['access'] = 'none';
$config['auth_override_class_method']['auth']['password_forget'] = 'none';
...
|
*/
$config['rest_keys_table'] = 'access_keys';
...
|
*/
$config['rest_limits_table'] = 'access_limits';
...
$config['rest_key_expiry'] = true;
$config['rest_key_expiry_time'] = 3600;
$config['rest_max_limit'] = 3000;
