...
{if $payment_methods_tab}
    ...
    {$payment_ewallet_status = $payment_gateway_array['ewallet_status']} {* {$payment_gateway_status = $payment_module_status_array['gateway_type']} *}
    ...
    {$squareup_status        = $payment_gateway_array['squareup_status']}
     {foreach from=$payment_gateway_using_repurchse_status item=v}
...
<div class="col-sm-12 bhoechie-tab-container">
    <div class=" col-sm-3 bhoechie-tab-menu">
        <div class="list-group">
            ...
            {foreach from=$payment_gateway_using_repurchse_status item=v}
              {if $payment_methods_tab}{if $v.gateway_name== 'E-pin' && $MODULE_STATUS['pin_status'] == "yes"}
            <a href="#" class="list-group-item text-center" {if $active_tab_val=='epin_tab' }class="active" {/if} onclick="changeActiveTab('epin_tab');">
            ...
            {/if} {if $v.gateway_name=='Authorize.Net'}
            ...
            {/if} *} {if $v.gateway_name=='Blockchain'}
            ...
            {/if} {if $v.gateway_name=='Free Joining'}
            ...
            <a href="#" class="list-group-item text-center active" {if $active_tab_val=='purchase_wallet_tab' }class="active" {/if} onclick="changeActiveTab('purchase_wallet_tab');">
