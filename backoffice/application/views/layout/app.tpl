...
<head>
   ...
   <meta name="viewport" content="width=device-width, initial-scale = 1.0, minimum-scale = 1.0, maximum-scale = 5.0, user-scalable = yes">
    ...
    <link rel="stylesheet" href="{$PUBLIC_URL}plugins/select2/dist/css/select2.min.css" type="text/css" />
     ...
     <link rel="stylesheet" type="text/css" href="{$PUBLIC_URL}css/bootstrap-slider.css">
    <link rel="stylesheet" type="text/css" href="{$PUBLIC_URL}css/bootstrap-slider.min.css">
    {*!-- end: THEME STYLES --*}
