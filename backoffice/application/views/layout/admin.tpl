...
{block name=content}
    ...
    {if $CURRENT_URL !="home/index" && $CURRENT_URL !="mail/mail_management"&& $CURRENT_URL !="mail/compose_mail" && $CURRENT_URL !="mail/read_mail" && $CURRENT_URL !="mail/reply_mail" && $CURRENT_URL !="auto_responder/auto_responder_details" &&  $CURRENT_URL !="auto_responder/auto_responder_settings" &&  $CURRENT_URL !="auto_responder/read_mail" && $CURRENT_URL !="mail/mail_sent"}
