<div class="modal right fade" id="fund_agent_credit_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-ewallet-area">
                    <h3>{lang('credit_agent_fund')}</h3>
                </div>
                {form_open('','id="fund_credit_form_agent"')}
                    <div class="popup-input">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="required">{lang('agent_user_name')}</label>
                                    <input class="form-control agent_autolist_new" type="text" id="user_name" name="user_name" autocomplete="Off" placeholder="{lang('user_name')}"/>
                                </div>
                            </div>
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
