<div class="modal right fade" id="fund_debit_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
                ...
                {form_open('','id="fund_debit_form"')}
                    <div class="popup-input">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <button type="submit" id="debit" name="debit" class="btn btn-primary">{lang('submit')}</button>
                                </div>
                            </div>
                        </div>
                    </div>
