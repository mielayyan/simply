                ...
                <div class="popup-input">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <label class="required"> {lang('from_username')} </label>
                                {* <input class="form-control user-search" id="from_user_name" name="from_user_name" type="text" placeholder="{lang('from_username')}"> *}
                                <input class="form-control user_autolist autocomplete-off" type="text" id="from_user_name" name="from_user_name" autocomplete="Off" placeholder="{lang('from_username')}"/> 
                        ...
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <label class="required"> {lang('epin')} </label>
                                <select name="epin" id="epin" class="form-control m-b">
                                    <option value="" selected="selected" id="epin_transfer_user_epin_list">{lang('select_epin')}</option>
                                </select>
