      ...
      <div class="d-flex my-auto">
        ...
        <div class="new-dashboard-btn">
          <div class="btn-group dropdown">
            <a href="#" data-toggle="modal" data-target="#create_epin_modal" style="float: left;">
                ...
                <div class="">
                  <div class="form-group select-check">
                    <select class="form-control" id="epin_status"   name="status">
                      ...
                      <option value="used_expired">{lang('used')}</option>
...
{include file="newui/admin/epin/create_epin.tpl"}
