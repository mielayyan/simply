    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <span  style="font-size: initial;float:right;margin-right: 10px;">{lang('total')} {format_currency($total_amount)} </span>{if $page_id}<br>{else}<br><br>{/if}
                        ...
                        <table class="table table-striped table-hover table-full-width table-bordered" id="">
                           ...
                           {assign var=color value=['progress-bar-aqua','progress-bar-red','progress-bar-green','progress-bar-yellow']}
                                ...
                                <tr>
                                   ...
                                   <td style="font-size: initial;">{format_currency($v.tot_amount)}</td>
                                </tr>
                            </tbody>
                            {else}
                            <tbody>
