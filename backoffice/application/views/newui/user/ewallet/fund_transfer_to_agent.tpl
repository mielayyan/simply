<div class="modal right fade" id="fund_transfer_modal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-ewallet-area">
                    <h3>{lang('fund_transfer_to_agent')}</h3>
                </div>
                {form_open('','id="fund_transfer_form1"')}
                    <div class="popup-input">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-xs-12 no-display">
                              ...
                              <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control agent_autolist_user" type="text" id="to_agent_name" name="to_agent_name" autocomplete="Off" placeholder="{lang('transfer_to')}"/> 
                                </div>
                            </div> 
                            ...
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <button type="submit" id="toagent_transfer" name="toagent_transfer" class="btn btn-primary">{lang('submit')}</button>
                                </div>
                            </div>
                        </div>
                    </div>
