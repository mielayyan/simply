...
<style type="text/css">
    ...
    {if $from_tree}
    <p class="text-right">
        <a href="{BASE_URL}/admin/genology_tree" class="btn btn-sm btn-info btn-addon"><i class="fa fa-backward"></i>{lang('back')}</a>
    </p>
    {/if}
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-8">
                    ...
                    {form_open_multipart('admin/binary_history', 'role="form" class="" name="searchform" id="searchform" method="get"')}
                    ...
                    <div class=" padding_both_small">
                        <div class="form-group m-b-n-xs">
                            ...
                            <a class="btn btn-sm btn-info" href="{$BASE_URL}admin/binary_history">
                            {lang('reset')} </a>
                        </div>
                    </div>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-avatar-details">
                                    <div>
                                        <img title="{if $v.active =='yes'} {lang('active')} {else} {lang('blocked')} {/if}" class="thumb-table" src="{profile_image_path($v.user_photo)}"/>
                                        {if $v.active =='yes'}
                           ...
                           {*  <td>
                                {if $v.active}
                                <i class="fa fa-check-circle" aria-hidden="true" title="Active" style="font-size: 23px;color: #1db340;"></i>
                                {else}
                                <i class="fa fa-times-circle" aria-hidden="true" title="In Active" style="font-size: 23px;color: #bbb;"></i>
                                {/if}
                            ...
                            {/if} *}
                            <td>
                                <a title="{lang('view_genealogy')}" href="{$BASE_URL}admin/tree/genology_tree?user_name={$v.user_name}" target="_blank" class="btn btn-light-grey btn-xs text-black"><i class="fa fa-sitemap"></i></a>
                                </td>
                        </tr>
                    {/foreach}
                </tbody>
