                          ...
                          <div class="modal-dialog modal-lg">
                            <div class="modal-dialog mt-6" role="document">
                              <div class="modal-content border-0">
                                ...
                                {/if}
                                <div class="modal-body py-8 px-8 text-left hidden-password-form" style="padding-top: 0;">
                          ...
                          <div class="modal-dialog modal-lg">
                            <div class="modal-dialog mt-6" role="document">
                              <div class="modal-content border-0">
                                ...
                                {/if}
                                <div class="modal-body py-8 px-8 text-left " style="padding-top: 0;">
                                  {form_open('', 'class="" id="forgot_trans_password" name="forgot_trans_password" method="post" onload="onloadCaptcha();"')}
                                      {* <div class="mb-3 ">
                                        <label class="form-label" for="modal-auth-password">{lang('email')}
                                        </label>
                                        <input type="text" class="form-control" id="e_mail_1" name="e_mail_1" placeholder="E-mail" value="{$profile_details['email']}" autocomplete="OFF" tabindex="2" readonly="true">
                                      </div> *}
