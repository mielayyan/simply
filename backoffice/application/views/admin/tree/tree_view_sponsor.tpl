    ...
    {foreach from= $tooltip_array item=v}
        <div id="user_{$v['user_name']}" class="tree_img_tree">
            <div class="Demo_head_bg">
                ...
                {$d = "{$a}{$b}{$c}"}
                {if file_exists($d)}
                    <a href="{$SITE_URL}/admin/profile/profile_view/{$v.user_id}"><img src="{$SITE_URL}/uploads/images/profile_picture/{$v['photo']}"/></a>
                {else}
                    <a href="{$SITE_URL}/admin/profile/profile_view/{$v.user_id}"><img src="{$SITE_URL}/uploads/images/profile_picture/nophoto.jpg" /></a>
                {/if}
                <p>{$v['user_name']}</p>
            </div>
