            ...
            <div class="tab">
                <div class="content">
                    ...
                    <div class="col-sm-3 padding_both">
                        ...
                        {form_error('current_pwd_admin')}
                    </div>
                    <div class="col-sm-3 padding_both_small">
                        <div class="form-group">
                            <label>{lang('new_password')}</label>
                            <input class="form-control act-pswd-popover" name="new_pwd_admin" type="password" id="new_pwd_admin" autocomplete="Off" />
                        </div>
                        {form_error('new_pwd_admin')}
                    </div>
                    <div class="col-sm-3 padding_both_small">
                        <div class="form-group">
            ...
            <div class="content">
                ...
                <div class="col-sm-3 padding_both">
                    <div class="form-group">
                        ...
                        <input class="form-control user_autolist autocomplete-off" type="text" id="user_name_common" name="user_name_common" value="" autocomplete="Off"><span id="referral_box" style="display:none;"></span> 
                        <span id="erro_user_name"></span>
                    </div>
                    {form_error('user_name_common')}
                </div>
                <div class="col-sm-3 padding_both_small">
                    <div class="form-group">
                        <label>{lang('new_password')}</label>
                        <input class="form-control act-pswd-popover" name="new_pwd_common" type="password" id="new_pwd_common" autocomplete="Off"/>
                    </div>
                    {form_error('new_pwd_common')}
                </div>
