        ...
        {form_open('', 'role="form" class="" method="post" name="rank_form" id="rank_form"')}
            ...
            {if $obj_arr['referal_count']}
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" maxlength="10" name="ref_count" id="ref_count"  {if $action == 'edit'} value="{$referal_count}" {else} value="{set_value('ref_count')}" {/if}>
                    {form_error('ref_count')}
                </div>
                <div class="form-group">
                    <label class="required">{lang('binary_max')}</label>
                    <input type="text" class="form-control" maxlength="10" name="binary_max" id="binary_max"  {if $action == 'edit'} value="{$binary_max}" {else} value="{set_value('binary_max')}" {/if}>
                    {form_error('binary_max')}
                </div>
                <div class="form-group">
                    <label class="required">{lang('gold_leg_count')}</label>
                    <input type="text" class="form-control" maxlength="10" name="gold_leg_count" id="gold_leg_count"  {if $action == 'edit'} value="{$gold_leg_count}" {else} value="{set_value('gold_leg_count')}" {/if}>
                    {form_error('gold_leg_count')}
                </div>
            {/if}
            ...
            {if $MODULE_STATUS['referal_status'] == "yes" && $commission_type == 'rank'}
                <div class="form-group">
                    ...
                    <div class="input-group {$input_group_hide}">
                        {$left_symbol}
                            <input type="text" class="form-control" maxlength="10" name="ref_commission" id="ref_commission"  {if $action == 'edit'} value="{$ref_commission}" {else} value="{set_value('ref_commission')}" {/if}>
                        {$right_symbol}
                    </div>
            ...
            {/if}
            <!--<div class="form-group">
                <label class="required">{lang('days')}</label>
                <div class="input-group {$input_group_hide}">
                    {$left_symbol}
                        <input type="text" class="form-control" maxlength="10" name="days" id="days"  {if $action == 'edit'} value="{$days}" {else} value="{set_value('days')}" {/if}>
                    {$right_symbol}
                </div>
                {form_error('days')}
            </div>-->
