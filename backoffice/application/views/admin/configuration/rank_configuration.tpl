...
<div id="span_js_messages" style="display:none;">
    ...
    <div class="panel panel-default">
        ...
        <legend><span class="fieldset-legend">{lang('rank_settings')}</span></legend>
            ...
            {form_open('','role="form" class="" name="rank_settings" id="rank_settings"')}
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <legend><span class="fieldset-legend">{lang('rank_details')}</span>
                        ...
                        <thead>
                            <tr>
                                ...
                                {if $obj_arr['referal_count']}
                                    ...
                                    <th>{lang('binary_max')}</th>
                                    <th>{lang('gold_leg_count')}</th>
                                {/if}
                        ...
                        {foreach from=$rank_details item=v}
                                <tr>
                                    ...
                                    {if $MLM_PLAN == 'Matrix' || $MLM_PLAN == 'Binary'}
                                      ...
                                      {/if}
                                    {/if}
                                    {*<td>{format_currency($v.rank_bonus)}</td> *}
                                    ...
                                    <td class="ipad_button_table">
                                        {if $v.rank_status=="active"}
                                            <button class="btn btn-light-grey btn-xs text-black" onclick="edit_rank({$v.rank_id}, '{$path}')" title="{lang('edit')}"> <i class="fa fa-edit"></i></button>
                                            <button class="btn btn-light-grey btn-xs text-black inactivate_membership_package" onclick="inactivate_rank({$v.rank_id}, '{$path}')" title="{lang('inactivate')}"><i class="fa fa-ban"></i></button>
                                        {else}
                                            <button class="btn btn-light-grey btn-xs text-black" onclick="activate_rank({$v.rank_id}, '{$path}')" title="{lang('activate')}"><i class="icon-check"></i></button>
                                        {/if}
                                    </td>
                                </tr>
                        {/foreach}
