...
{block name=script}
    ...
    <script>
        ...
        {
            var set_module_status = path_root + "configuration/update_module";
                ...
                <div class="">
                    ...
                    <table class="table table-striped" id="">
                        ...
                        <tbody>
                            ...
                            {if $MODULE_STATUS['rank_status_demo']=='yes'}
                            <tr>
                                <td>{lang('rank')}</td>
                                <td>   
                                    <label class="bg-primary i-switch make-switch" data-on="success" data-off="warning">
                            ...
                            <!--{if $MODULE_STATUS['opencart_status']=='no' && $MODULE_STATUS['product_status']=='yes'}
                                <tr>
                                    ...
                                    <td>   
                                        <label class="bg-primary i-switch make-switch" data-on="success" data-off="warning">
                                            <input type="checkbox" name="set_module_status" id="set_product_validity" value="yes" {if $MODULE_STATUS['subscription_status']=="no"}   onChange="change_module_status('{$PUBLIC_URL}', '{$PATH_TO_ROOT_DOMAIN}admin/', 'product_validity', 'yes')" {else} checked onChange="change_module_status('{$PUBLIC_URL}', '{$PATH_TO_ROOT_DOMAIN}admin/', 'product_validity', 'no')" {/if} >   
                                            <i></i>                          
                                        </label>
                            ...
                            {if $MODULE_STATUS['product_status']=='yes' && $MODULE_STATUS['hyip_status']!="yes"}
                                <tr>
                                    <td>{lang('Hyip')}</td>
                                    <td>   
                                        <label class="bg-primary i-switch make-switch" data-on="success" data-off="warning">
                            ...
                            {if $MODULE_STATUS['promotion_status_demo']=='yes'}
                                <tr>
                                    <td>{lang('35_#')}</td>
                                    <td>   
                                        <label class="bg-primary i-switch make-switch" data-on="success" data-off="warning">
                                            <input type="checkbox" name="set_module_status" id="set_promotion_status" value="yes" {if $MODULE_STATUS['promotion_status']=="no"}   onChange="change_module_status('{$PUBLIC_URL}', '{$PATH_TO_ROOT_DOMAIN}admin/', 'promotion_status', 'yes')" {else} checked onChange="change_module_status('{$PUBLIC_URL}', '{$PATH_TO_ROOT_DOMAIN}admin/', 'promotion_status', 'no')" {/if} >                         
                                            <i></i>    
                                        </label>
                                        <span id="promotion_status" style="display:none;"></span>
                                    </td>
                                    <td></td>
                                </tr>
                            {/if}
                            {if $MODULE_STATUS['subscription_status_demo']=='yes'}
                            <tr>
                                <td>{lang('subscription')}</td>
                                <td>   
                                    <label class="bg-primary i-switch make-switch" data-on="success" data-off="warning">
                                        <input type="checkbox" name="set_module_status" id="set_subscription_config" value="yes" {if $MODULE_STATUS['subscription_status']=="no"}   onChange="change_module_status('{$PUBLIC_URL}', '{$PATH_TO_ROOT_DOMAIN}admin/', 'subscription_status', 'yes')" {else} checked onChange="change_module_status('{$PUBLIC_URL}', '{$PATH_TO_ROOT_DOMAIN}admin/', 'subscription_status', 'no')" {/if} >                             
                                        <i></i>
                                    </label>
                                    <span id="signup_config" style="display:none;"></span>
                                </td>
                                <td>
                                        {if $MODULE_STATUS['subscription_status']=='yes' && $MODULE_STATUS['subscription_status_demo'] == "yes"}
                                            <a class="btn btn-sm btn-icon btn-rounded btn-default" href="{$PATH_TO_ROOT_DOMAIN}admin/subscription_config"><i class="fa fa-cog"></i></a>
                                        {/if}
                                </td>
                            </tr>
                            {/if}
