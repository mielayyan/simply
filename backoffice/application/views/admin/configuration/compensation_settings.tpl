...
<div class="panel panel-default">
    {* <div class="panel-body"> *}
        ...
        <div class="table-responsive">
            <table class="table table-striped" id="compensation_page">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="v-middle"> {if $MLM_PLAN  eq 'Binary'}
                    ...
                    {if ($MLM_PLAN =="Party" && $MODULE_STATUS['sponsor_commission_status'] == "yes" ) || ($MLM_PLAN !="Party")}
                        <tr>
                            <td class="v-middle">{if $MODULE_STATUS['xup_status'] == 'yes'} {lang('xup_commission')} {else} {lang('level_commission')} {/if}</td>
                            <td class="v-bottom">
                                <div class="form-group-button">
                                    <label class="i-switch bg-primary">
                    ...
                    {if $MODULE_STATUS['rank_status']=='yes'}
                        <tr>
                            <td class="v-middle">{lang('rank_commission')}</td>
                            <td class="v-bottom">
                                <div class="form-group-button">
                                <label class="i-switch bg-primary">
                    ...
                    <tr>
                        <td class="v-middle">{lang('referal_commission')}</td>
                        <td class="v-bottom">
                            <div class="form-group-button">
                                <label class="i-switch bg-primary">
                    ...
                    {if $MODULE_STATUS['roi_status'] == 'yes'}
                        <tr>
                            <td class="v-middle">{lang('hyip_commission')}</td>
                            <td class="v-bottom">
                                <div class="form-group-button">
                                <label class="i-switch bg-primary">
                    ...
                    {if $bonus['matching_bonus'] == 'yes'}
                        <tr>
                            <td class="v-middle">{lang('matching_bonus')}</td>
                            <td class="v-bottom">
                                <div class="form-group-button">
                                    <label class="i-switch bg-primary">
                    ...
                    {if $MODULE_STATUS['rank_status']=='yes' && $bonus['pool_bonus'] == 'yes'}
                        <tr>
                            <td class="v-middle">{lang('pool_bonus')}</td>
                            <td class="v-bottom">
                                <div class="form-group-button">
                                    <label class="i-switch bg-primary">
                    ...
                    {if $bonus['fast_start_bonus'] == 'yes'}
                        <tr>
                            <td class="v-middle">{lang('fast_start_bonus')}</td>
                            <td class="v-bottom">
                                <div class="form-group-button">
                                    <label class="i-switch bg-primary">
                    ...
                    {if $bonus['performance_bonus'] == 'yes'}
                        <tr>
                            <td class="v-middle">{lang('performance_bonus')}</td>
                            <td class="v-bottom">
                                <div class="form-group-button">
                                    <label class="i-switch bg-primary">
                    ...
                    {if $MODULE_STATUS['repurchase_status']=='yes' || ($MODULE_STATUS['opencart_status'] == "yes" && $MODULE_STATUS['opencart_status_demo'] == "yes")}
                        <tr>
                            <td class="v-middle">{lang('sales_commission')}</td>
                            <td class="v-bottom">
                                <div class="form-group-button">
                                    <label class="i-switch bg-primary">
                    ...
                    {/if}
                    <tr>
                        <td class="v-middle">{lang('Ranks Promo')}</td>
                        <td class="v-bottom">
                            <div class="form-group-button">
                                <label class="i-switch bg-primary">
                                    <input type="checkbox" class="compensations" data-name="rank_promotion_status" name="rank_promotion_status" {if $rank_promotion_status == 'yes'} checked {/if}>
                                    <i></i>
                                </label>
                            </div>
                        </td>
                        <td><a href="{if $rank_promotion_status == 'yes'} {$BASE_URL}admin/configuration/rank_promo {else} javascript:void(0); {/if}"class="btn btn-sm btn-icon {if $rank_promotion_status == 'yes'} btn-rounded btn-default {else} btn-disabled btn-muted{/if}"> <i class="fa fa-cog"></i></a></td>
                    </tr>
                </tbody>
            </table>
