        ...
        {form_open('','role="form" class="" name="form_setting" id="form_setting"')}
            ...
            {if $active_commission == "genealogy"}
                ...
                {foreach from=$arr_level item=v}
                    {if $level < $obj_arr['matching_upto_level']}
                        {$level = $level + 1}
                        {$levl_perc = $v}
                        <div class="form-group">
                            ...
                            <div class="input-group {$input_group_hide}">
                                {$left_symbol}
                                <input type="text" maxlength="5" class="level_percentage form-control" name="level_percentage{$level}" data-lang="{lang('you_must_enter')} {lang('level')|strtolower} {$level} {lang('bonus_')|strtolower}" id="level_per{$level}" min="0" value="{number_format($levl_perc, 0, '', '')}">
                                {$right_symbol}
                            </div>
