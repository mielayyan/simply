        ...
        {if $MODULE_STATUS['referal_status'] == "yes"}
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="referal_commission_type"  id="referal_commission_type_new" onchange="change_referal_commission_type(this.value);">
                    <option value="percentage" {if $obj_arr["referal_commission_type"]=='percentage'} selected="true"{/if}>{lang('percentage')}</option>
                    <option value="flat" {if $obj_arr["referal_commission_type"]=='flat'} selected="true"{/if}>{lang('flat')}</option>
                </select>
                {form_error("referal_commission_type")}
            </div>
                <div class="form-group">
                    ...
                    {/if}
                    {if $MODULE_STATUS['rank_status'] == "yes" && $obj_arr["referal_commission_type"]=='flat'}
                    ...
                    {foreach from=$rank_details item=u}
                        <div class="form-group">
                            <label class="required">
                                ...
                                <span class="referal_commission">{if $obj_arr["referal_commission_type"] == "percentage"}%{/if}</span>
                            </label>
                    ...
                    {foreach from=$product_details item=u}
                        <div class="form-group">
                            <label class="required">
                                ...
                                <span class="span_referal_commission">{if $obj_arr["referal_commission_type"] == "percentage"}%{/if}</span>
                            </label>
                            <div class="input-group {$input_group_hide}">
                                {$left_symbol}
