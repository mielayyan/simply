                    ...
                    {* {if $level < $obj_arr['depth_ceiling']} *}
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group {$input_group_hide}">
                                {$left_symbol}
                                <input type="text" maxlength="5" class="level_percentage form-control" name="level_percentage{$level}" data-lang="{lang('you_must_enter')} {lang('level')|strtolower} {$level} {lang('sales_perc')|strtolower}" id="level_per{$level}" min="0" value="{number_format($levl_perc, 0, '', '')}">
                                {$right_symbol}
                            </div>
                                            ...
                                            <td>
                                                <div class="input-group {$input_group_hide}">
                                                    ...
                                                    <input 
                                                        type="text" 
                                                        maxlength="5" 
                                                        class="pck_percentage form-control" 
                                                        name="level_{$u['level']}_{$v['prod_id']}_sales" 
                                                        data-lang="{lang('you_must_enter')} {lang('level')|strtolower} {$u['level']} {$v['prod_id']} {lang('sales_perc')|strtolower}" 
                                                        id="level_{$u['level']}_{$v['prod_id']}_sales" 
                                                        min="0" 
                                                        value="{$u[{"{$v['prod_id']}sales"}]}"
                                                    >
                                                    {* {$right_symbol} *}
                                                </div>
                        ...
                        {foreach from=$arr_pck item=v}
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    {* {$left_symbol} *}
                                    <input type="text" maxlength="5" class="pck_percentage form-control" name="level_{$u['level']}_{$v['prod_id']}_sales" data-lang="{lang('you_must_enter')|strtolower} {lang('level')} {$u['level']} {$v['prod_id']} {lang('sales_perc')|strtolower}" id="level_{$u['level']}_{$v['prod_id']}_sales" min="0" 
                                    {if isset($u[{"{$v['prod_id']}sales"}])}
                                        value="{$u[{"{$v['prod_id']}sales"}]}"
                                    {/if}
                                    >
                                    {* {$right_symbol} *}
