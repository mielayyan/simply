    ...
    <legend><span class="fieldset-legend">{lang('e_pin_configuration')}</span></legend>
        {form_open('','role="form" class="" name="pin_config_form" id="pin_config_form"')}
            ...
            {* <div class="form-group">
                ...
                <input type="number" class="form-control" name="pin_maxcount" id="pin_maxcount"  value="{$pin_config["pin_maxcount"]}">
...
<div class="panel-body">
   ...
   {form_open('admin/configuration/delete_amount_details','role="form" class="" method="post"  name="delete_mem1" id="delete_mem1"')}
        ...
        <thead>
            <tr>
                <th><div class="checkbox">
                            <label class="i-checks i-checks-sm">
                                <input type="checkbox" name="check_all1" id="check_all1" class="" value=""/><i> </i>
                            </label>
                        </div></th>
                ...
                {foreach from=$pin_amounts item=v}
                    ...
                    <tr>
                        <td><div class="checkbox">
                                <label class="i-checks i-checks-sm">
                                    <input type="checkbox" name="delete_amount[]" id="delete_amount{$i}" class="delete_details"  value="{$v.id}"/><i> </i>
                                </label>
                            </div></td>
    ...
    {if $count!=0}
       <div class="col-sm-3 padding_both_small">
                <div class="form-group panel-footer">
                    <button class="btn btn-sm btn-primary " type="submit" name="delete_list" id="delete_list" value="{lang('delete')}">{lang('delete')}</button>
               </div>
            </div> 
    {/if}
