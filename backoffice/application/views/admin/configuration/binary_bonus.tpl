...
{block name=$CONTENT_BLOCK}
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="point_value" id="point_value" value="{$binary_bonus_config['point_value']}" maxlength="10">
            ...
            <div class="form-group">
                <label class="required">{lang('pair_count')}</label>
                <input class="form-control" name="pair_count" id="pair_count" value="{$binary_bonus_config['pair_count']}" maxlength="10">
                {form_error('pair_count')}
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="pair_value" id="pair_value" value="{$binary_bonus_config['pair_value']}" maxlength="10">
                ...
                {foreach from=$package_list item=pack}
                    <div class="form-group">
                        ...
                        <div class="input-group {$input_group_hide}">
                            ...
                            <input type="number" class="form-control pair-commission" name="pair_commission_{$pack['product_id']}" id="pair_commission_{$pack['product_id']}" value="{number_format($pack['pair_price'] * $DEFAULT_CURRENCY_VALUE, 2, '.', '')}" maxlength="10" >
                            {else $binary_bonus_config['commission_type']=='percentage'}
                             <input type="number" class="form-control pair-commission" name="pair_commission_{$pack['product_id']}" id="pair_commission_{$pack['product_id']}" value="{number_format($pack['pair_price'], 2, '.', '')}" maxlength="10">
                             {/if}
                        </div>
            ...
            {else}
                <div class="form-group">
                    ...
                    <div class="input-group {$input_group_hide}">
                        {$left_symbol}
                        <input class="form-control pair-commission" name="pair_commission" id="pair_commission" value="{$binary_bonus_config['pair_commission']}" maxlength="10">
                        {$right_symbol}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="flush_out_limit" id="flush_out_limit" value="{$binary_bonus_config['flush_out_limit']}" maxlength="10">
            ...
            <div class="form-group">
                <div class="checkbox">
                  <label class="i-checks">
                    <input type="checkbox" name="block_binary_pv" id="block_binary_pv" {if $binary_bonus_config['block_binary_pv']=='yes'} checked {/if}><i></i> {lang('block_binary_pv')}
                  </label>
                </div>
            </div>
            <div class="form-group">
                <label class="required">{lang('step_distribution_15')}</label>
                <input class="form-control" name="step_distribution_15" id="step_distribution_15" value="{$binary_bonus_config['step_distribution_15']}" maxlength="10">
                {form_error('step_distribution_15')}
            </div>
            <div class="form-group">
                <label class="required">{lang('step_distribution_10')}</label>
                <input class="form-control" name="step_distribution_10" id="step_distribution_10" value="{$binary_bonus_config['step_distribution_10']}" maxlength="10">
                {form_error('step_distribution_10')}
            </div>
            <div class="form-group">
                <label class="required">{lang('step_distribution_5')}</label>
                <input class="form-control" name="step_distribution_5" id="step_distribution_5" value="{$binary_bonus_config['step_distribution_5']}" maxlength="10">
                {form_error('step_distribution_5')}
            </div>
            <div class="form-group">
    ...
    {* <div class="panel panel-default">
        <div class="panel-heading"><h4>Binary Commission Extra Distribution</h4></div>
        <div class="panel-body">
            {* <legend><span class="fieldset-legend">{lang('binary_commission')}</span></legend> *}
            {*{form_open('','role="form" class="" name="form_setting" id="form_setting"')}
            {include file="layout/error_box.tpl"}
            ...
            <div class="form-group">
                <label class="required">{lang('calculation_period')}</label>
                <select class="form-control" name="calculation_period_extra" id="calculation_period_extra">
                    <option value="instant_extra" {if $binary_bonus_config['calculation_period']=='instant'} selected {/if}>{lang('instant')}</option>
                    <option value="daily_extra" {if $binary_bonus_config['calculation_period']=='daily'} selected {/if}>{lang('daily')}</option>
                    <option value="weekly_extra" {if $binary_bonus_config['calculation_period']=='weekly'} selected {/if}>{lang('weekly')}</option>
                    <option value="monthly_extra" {if $binary_bonus_config['calculation_period']=='monthly'} selected {/if}>{lang('monthly')}</option>
                </select>
                {form_error('calculation_period')}
            </div>
            <div class="form-group">
