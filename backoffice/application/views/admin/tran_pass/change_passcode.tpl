...
<div id="span_js_messages" style="display:none;">
   ...
   <span id="error_msg3">{lang('transaction_password_length_should_be_more_than_6')}</span>
      ...
      <div class="tab">
         <div class="content">
            ...
            <div class="form-group">
               ...
               <input class="form-control act-pswd-popover" type="password" name="new_passcode" id="new_passcode" tabindex="2" maxlength="32" />{form_error('new_passcode')}
            </div>
            </div>
            <div class="col-sm-3 padding_both_small">
            <div class="form-group">
      ...
      <div class="tab">
         <div class="content">
            ...
            <div class="form-group">
               ...
               <input class="form-control user_autolist autocomplete-off" type="text" id="user_name" name="user_name" autocomplete="Off" tabindex="0" >  {form_error('user_name')} 
            </div>
            </div>
            <div class="col-sm-3 padding_both_small">
            <div class="form-group">
               <label >{lang('new_password')}<font color="#ff0000">*</font></label>
               <input class="form-control act-pswd-popover" type="password" name="new_passcode_user" id="new_passcode_user" maxlength="32" tabindex="0" /> {form_error('new_passcode_user')} 
            </div>
            </div>
            <div class="col-sm-3 padding_both_small">
            <div class="form-group">
