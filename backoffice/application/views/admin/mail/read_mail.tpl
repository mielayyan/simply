...
<div id="span_js_messages" style="display:none;">
    ...
    <div class="hbox hbox-auto-xs hbox-auto-sm" >
        ...
        <div class="wrapper b-b ">
          <h4 class="font-thin m-n ">{$mail_details[0]['subject']}</h4>
        </div>
        <div class="wrapper b-b ">
          {$i = 0}
          {$id = ""}
          ...
          {else}
          <div class="wrapper b-b">
          <h4 class="font-thin m-n ">{$mail_details['contact_name']} Contacted You</h4>
        </div>
                <div class="wrapper ">
                 <div class="panel-heading"> 
                            <div  class="wrapper m-b-lg">
        ...
        <div class="wrapper">
            <div class="panel b-a reply_mail_fixed">
                <div class="panel-heading reply_mail_bg" >
                  <div class=""> <!-- remove class m-b-lg -->
                    Click here to<a href="{$BASE_URL}admin/mail/reply_mail/{$id}" class="text-danger" ><span  onclick="getUsername('{$user_name}', '{$subject}');"> Reply</span></a> 
                  </div>
                </div>
            </div>
        </div>
