...
<div class="panel panel-default">
  ...
  {form_open('admin/report/agent_credit_report_view','role="form" class="" method="get"  name="searchform" id="searchform" target="_blank"')}
      {include file="layout/error_box.tpl"}
      <div class="col-sm-3 padding_both">
      <div class="form-group">
        <label class="required">{lang('agent_user_name')}</label>
        <input type="text" class="form-control agent_autolist" autocomplete="Off" id="agent_user_name" name="agent_user_name">
      </div>
