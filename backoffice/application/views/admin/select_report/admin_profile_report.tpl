...
<div class="panel panel-default">
  ...
  {form_open('admin/report/profile_report_view','role="form" class="" method="get"  name="searchform" id="searchform" target="_blank"')}
...
<div class="panel panel-default">
  <div class="panel-body">
    {form_open('admin/profile_report','role="form" class=""  name="searchform1" id="searchform1" target="_blank" method="get"')}
    {include file="layout/error_box.tpl"}
      <div class="col-sm-3 padding_both">
    <div class="form-group">
...
<div class="panel panel-default">
  <div class="panel-body">
    {form_open('admin/profile_report_multiple_count','role="form" class=""   name="from_to_form" id="from_to_form" method="get" target="_blank"')}
      {include file="layout/error_box.tpl"}
      <div class="col-sm-3 padding_both">
      <div class="form-group">
