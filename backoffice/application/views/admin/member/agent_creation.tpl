                ...
                <input type="hidden" id="path_root" name="path_root" value="{$PATH_TO_ROOT_DOMAIN}">
                    ...
                    <div class="form-group">
                        <label class="control-label required" for="agent_firstname">{lang('first_name')}</label>
                            <input class="form-control" type="text"  name="agent_firstname" id="agent_firstname" required  autocomplete="Off" tabindex="2"  value="{if $edit_id !=''}{$agent_firstname}{/if}">
                            {form_error('agent_firstname')}
                    </div>
                    
                    <div class="form-group">
                        <label class="control-label required" for="agent_secondname" >{lang('last_name')}</label>
                            <input class="form-control"  type="text"  name="agent_secondname" id="agent_secondname"  required autocomplete="Off" tabindex="3"value="{if $edit_id !=''}{$agent_secondname}{/if}">
                            {form_error('agent_secondname')}
                    </div>
                    
                    <div class="form-group">
                        <label class="control-label required" for="agent_email">{lang('email')}</label>
                            <input class="form-control" type="text"  name="agent_email" id="agent_email" required autocomplete="Off" tabindex="4" value="{if $edit_id !=''}{$agent_email}{/if}">
                            {form_error('agent_email')}
                    </div>

                    <div class="form-group">
                        <label class=" control-label required" for="agent_mobile" >{lang('mobile_no')}</label>
                            <input class="form-control" type="text"  name="agent_mobile" id="agent_mobile" required  autocomplete="Off" tabindex="5" value="{if $edit_id !=''}{$agent_mobile}{/if}">
                    ...
                    {* <div class="form-group">
                        <label class="control-label required" for="country" >{lang('country')}</label>
                       <select name="country" id="country" class="form-control" onchange="getAllCountries(this.value);">{$countries}</select> 
                    ...
                    <div class="form-group">
                        ...
                        {* <select multiple name="agent_country[]" id="agent_country"  required class="form-control select2">{$countries}
                        </select> *}
                        {if $countries !=''} <select multiple name="agent_country[]" id="agent_country"  required class="form-control select2">{$countries}</select>{else}<select multiple name="agent_country[]" id="agent_country"  required class="form-control select2">{$countries}
                        </select>
                        {/if}
                    </div>
                    ...
                    {if $edit_id ==''}
                     <div class="form-group">
                        <label class="control-label required" for="agent_password">{lang('password')}</label>
                            <input class="form-control act-pswd-popover" type="password"  name="agent_password" id="agent_password" tabindex="6" autocomplete="Off" size="24" maxlength="20" value="{if $edit_id !=''}{$agent_password}{/if}"  >
                        {form_error('agent_password')}
                    </div>

                    <div class="form-group">
                        <label class="control-label required" for="cagentpswd"  >{lang('confirm_password')}</label>
                            <input class="form-control" name="cagentpswd" id="cagentpswd" type="password" tabindex="7" autocomplete="Off" size="24" maxlength="20" value="{if $edit_id !=''}{$agent_password}{/if}">
                    ...
                    {* <div class="form-group">
                        <label class="control-label required" for="ref_username" >{lang('select_agent')}</label>
                             <input class="form-control countrywise_user_autolist" onchange="getAllCountries(this.value);" type="text" id="user_name" name="user_name" value="" tabindex="5" autocomplete="Off" >
                                {form_error('user_name')}
                    </div> *}
                    
                    
 
                    <button class="btn btn-sm btn-primary" name="assign" id="assign" tabindex="8" value="{lang('Assign Agent')}" >
                     {if $edit_id !=''} {lang('Update Agent')} {else} {lang('Assign Agent')} {/if}</button>
