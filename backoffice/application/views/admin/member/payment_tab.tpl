{form_open('admin/member/package_validity_submit', 'role="form" class="" method="post"  name="form" id="msform"')}
...
{if $payment_methods_tab}
    ...
    {$squareup_status = $payment_gateway_array['squareup_status']}
     {foreach from=$payment_gateway_using_membership_status item=v}
                        ...
                        <div class="row col-sm-12">
                            ...
                            <div class=" mark_paid col-sm-3 padding_both_small" id="check_ewallet_button">
                                <div class="form-group row">
                                    <button type="button" id ="ewallet_btn" name= "ewallet_btn" value = "Check Availability" onclick="validate_ewallet();" class="btn btn-sm btn-primary " style="margin-left: 20px;">{lang('check_availability')}</button>
                                    <button type="submit" name="ewallet_submit" id="ewallet_submit" class="btn btn-sm btn-primary "  disabled="" style="">{lang('finish')}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bhoechie-tab-content bank {if $active_tab_val=='bank_transfer'}active{/if}">
                    <div class="content">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="bank_info" style="height:150px;" readonly="true" name="bankinfo">{$bank_details['account_info']}</textarea> 
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <button type="button" class="btn btn-addon m-b-xs btn-info upload_reciept" id="upload_reciept"> <i class="fa fa-arrow-circle-o-up"></i> {lang('upload')} </button>
                                   {if $DEMO_STATUS =="yes"}
                                        <input type="button" name="previous" class="previous action-button-previous" value="{lang('previous')}"/>
                                        <input type="submit" name="submit_bank_transfer" class="submit_bank_transfer action-button sw-btn-finish" value="{lang('finish')}" disabled="disabled"/>
                                   {/if}
                        </div>
                        </div>
                </div>
