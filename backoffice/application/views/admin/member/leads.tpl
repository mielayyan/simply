...
{block name=$CONTENT_BLOCK}
    <div class="panel panel-default">
        <div class="panel-body">
            {form_open('admin/leads','role="form" class="" method="get"  name="search_mem" id="search_mem"')}
                ...
                <tbody>
                    ...
                    {foreach from=$details item=v}                        
                        ...
                        <tr class="{$tr_class}">
                            ...
                            <td>{$v.status}</td>
                            <td> 
                                <a class="btn btn-light-grey btn-xs text-black" title="Edit" href ="javascript:getleadetails({$v.id},'{$BASE_URL}admin')"><i class="fa fa-edit"></i></a>
                            </td></tr>
                        {/foreach}
                </tbody>
