...
{block name=$CONTENT_BLOCK}
    ...
    <div class="button_back">
        <a href="{BASE_URL}/admin/member/upgrade_package_validity"> <button class="btn m-b-xs btn-sm btn-info btn-addon"><i class="fa fa-backward"></i>{lang('back')}</button></a>
    </div>
    <div class="row">
        <div class="col-lg-12">
                        ...
                        {if count($expired_users)>0}
                            ...
                            <table class="table table-responsive boder_none_modal">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="width_name_space">{lang('subscription_end')}</td>
                                        <td class="width_name_space_dot">:</td>
                                        <td>{$product_validity|date_format:"d M Y - h:i:s A"}</td>
                                    </tr>
                                    <tr>
                                        <td class="width_name_space">{lang('renewal_charge')}</td>
                                        <td class="width_name_space_dot">:</td>
