     ...
     <div class="panel-body">
      {form_open('/admin/post_fund_management','role="form" class="form" method="post"  name="fund_form" id="fund_form"')}
        ...
        <div class="form-group">
            ...
            <input class="form-control user_autolist" type="text" id="user_name" name="user_name" autocomplete="Off" value="{set_value('user_name')}"/> {form_error('user_name')}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="tran_concept" style="height: 120px;"rows="10" placeholder="" id="tran_concept">{set_value('tran_concept')}</textarea> {form_error('tran_concept')}
        </div>
        <div class="form-group ">
