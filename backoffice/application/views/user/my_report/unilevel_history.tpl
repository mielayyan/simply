        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    {form_open_multipart('user/unilevel_history', 'role="form" class="" name="searchform" id="searchform" method="get"')}
                    ...
                    <div class=" padding_both_small">
                        <div class="form-group m-b-n-xs">
                            ...
                            <a class="btn btn-sm btn-info" href="{$BASE_URL}user/unilevel_history">
                            {lang('reset')} </a>
                        </div>
                    </div>
                    </div>
                ...
                <tbody>
                    {foreach from=$binary item=v}
                        ...
                        <tr>
                            ...
                            {/if} *}
                            <td>
                                <a title="{lang('view_sponsor')}" href="{$BASE_URL}user/tree/sponsor_tree/{$v.user_name}" target="_blank" class="btn btn-light-grey btn-xs text-black"><i class="fa fa-sitemap"></i></a>
                                </td>
                        </tr>
                    {/foreach}
                </tbody>
