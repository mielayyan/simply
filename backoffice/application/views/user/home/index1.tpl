  ...
  <div class="row">
                                             ...
                                             <div class="">
                                                 <div class="link-replica link-replica2 coply-link" >
                                                     ...
                                                     <div class="promotion-social social_iocns" >
                                                       ...
                                                       <a href="{$simply_url}" target="_blank">
                                                         <button type="button" class="rpl-social icons_bg" onclick="" >
     ...
     <div class="col-lg-12 ">
            <div class="panel-body panel">
                ...
                <!-- Lead Capture-link -->
                <div class="user-det">
                    <div class=" grid {if isset($binary_tree_carry)}grid_five{else} grid-four{/if} {if $MLM_PLAN != 'Binary'} grid_three{/if} ">
                      {if $is_app}
                        
                            <div class="sponsor-details vertical_line" style="padding-left: 40px !important;" >
                                <div class="sponsor-details-icon"><i class="fa fa-money" aria-hidden="true"></i></div>
                                <span class="extra_data_title">
                                {lang('founders_pool')}</span>
                                <div class="extra_data">{$founderspool_bonus|default:0}
                                </div>
                                
                            </div>
                           
                            <div class="sponsor-details vertical_line">
                              <div class="sponsor-details-icon"><i class="fa fa-certificate" aria-hidden="true"></i></div>
                                <span class="extra_data_title">
                                {lang('gold_pool')}</span>
                                <div class="extra_data">{$pool_shares['Gold']|default:0}
                                </div>
                            ...
                            <div class="sponsor-details vertical_line">
                              ...
                              <span class="extra_data_title">
                                {lang('ruby_pool')}</span>
                                <div class="extra_data">{$pool_shares['Ruby']|default:0}</div>
                                ...
                                <div class="sponsor-details vertical_line">
                                  ...
                                  <span class="extra_data_title">
                                    ...
                                    <div class="extra_data">{$pool_shares['Diamond']|default:0}
                                    </div>
                                ...
                                <div class="sponsor-details vertical_line">
                                  ...
                                  <span class="extra_data_title">
                                    ...
                                    <div class="extra_data">{$pool_shares['Legend']|default:0}
                                    </div>
                           ...
                           {if $dashboardConfig["pv"] == 1 }
                            <div class="sponsor-details vertical_line">
                              <div class="sponsor-details-icon"><i class="fa fa-user" aria-hidden="true"></i></div>
                                <span class="extra_data_title" style="padding-left: 20px;">
        ...
        <div class="panel wrapper">
            ...
            <div class="current-next-new {$next_column_class}">
                <div class="current-new">
                    ...
                    <h4 class="m-t-none m-b text-primary-lt font-thin-bold">{lang('Rank Promo')}</h4>
                    ...
                    <div class="current-new-section">
                      {foreach from=$current_pool item=$rank key=$key}
                        {if $key != 'downline_package_count' && $key != 'downline_rank' && $key != 'criteria'}
                        <div class="current-new-container">
                            <div class="CN-one"><div ui-jq="easyPieChart" ui-options="{
                                  percent: {round($rank['percentage'], 1)},
                            ...
                            <div class="CN-four"><div><h4 class="text-success">{$rank['achieved']}</h4>
                              <h5>{lang('achieved')}</h5></div></div><!-- CN four -->
                              {else}
                              <div class="CN-four"><div><h4 class="text-success"><h5>{format_currency($rank['bonus_amount'])}</h4>
                                  </h5></div>
                                </div>
                              {/if}
                        </div>
                        {else if $key != 'criteria'}
                          {foreach from=$rank  item=$r key=$key2}
                            ...
                            <div class="CN-four"><div><h4 class="text-success">{$r.achieved}</h4>
                              <h5>Achieved</h5></div></div><!-- CN four -->
                              {else}
                                <div class="CN-four"><div><h4 class="text-success"><h5>{format_currency($r.bonus_amount)}</h4>
                                  </h5></div>
                                </div>
                              {/if}
                        </div>
