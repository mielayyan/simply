                ...
                <tbody>
                    {foreach from=$identity_proof item=v}
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-light-grey btn-xs text-black" type="submit" id="delete" name='delete' title="{lang('delete')}" value="{$v['id']}"> <i class="fa fa-trash-o"></i></button>
                            </td>
                        </tr>
                        {form_close()}
                    {/foreach}
    ...
    <script>
        jQuery(document).ready(function () {
            $(document).on('click','#delete',function(){
                var txt;
                var r = confirm(trans('are_you_sure_want_delete'));
                if (r == false) {
                  return false
                }
            })
