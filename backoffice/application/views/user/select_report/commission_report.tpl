...
<div class="panel panel-default">
    <div class="panel-body">
        {form_open('user/commission_report_view','role="form" class="" method="get" name="commision_form" id="commision_form" target="_blank" onsubmit="return validation()"')}
            ...
            <div class="col-sm-3 padding_both_small">
                <div class="form-group padding_both_small">
