...
{assign var="excel_url" value="{$BASE_URL}user/excel/create_excel_group_pv_report/?username={$user_name}&&date_range={$daterange}&&from_date={$from_date}&&to_date={$to_date}"} 
{assign var="csv_url" value="{$BASE_URL}user/excel/create_csv_group_pv_report/?username={$user_name}&&date_range={$daterange}&&from_date={$from_date}&&to_date={$to_date}"}
{assign var="report_name" value="{lang('group_pv_report')}"}

<div class="panel panel-default">
    <div class="panel-body">
        {form_open('user/report/group_pv_report','role="form" class="" method="get" name="commision_form" id="commision_form" onsubmit="return validation()"')}
