...
$(function () {
    ...
    ewallet_statement_table = $('#ewallet_statement_table').DataTable({
        ...
        deferLoading: 0,
        ajax: {
            url: $('#base_url').val() + "admin/ewallet/statement_agent",
            type: 'GET',
            data: function (d) {
                return $.extend({}, d, {
    ...
    transfer_history_table = $('#transfer_history_table').DataTable({
        ...
        deferLoading: 0,
        ajax: {
            url: $('#base_url').val() + "admin/ewallet/transfer_history_agent",
            type: 'GET',
            data: function (d) {
                return $.extend({}, d, {
                    /*'user_names': $('#epin_list_filter_form .user-search-select2').val(),
    ...
    purchase_wallet_table = $('#purchase_wallet_table').DataTable({
        ...
        deferLoading: 0,
        ajax: {
            url: $('#base_url').val() + "admin/ewallet/purchase_wallet_table_agent",
            type: 'GET',
            data: function (d) {
                return $.extend({}, d, {
                    /*'user_names': $('#epin_list_filter_form .user-search-select2').val(),
    ...
    user_earnings_table = $('#user_earnings_table').DataTable({
        ...
        deferLoading: 0,
        ajax: {
            url: $('#base_url').val() + "admin/ewallet/user_earnings_table_agent",
            type: 'GET',
            data: function (d) {
                return $.extend({}, d, {
...
$("#fund_transfer_form").on('submit', function (e) {
    ...
    var form = $(this);
    $.ajax({
        url: $('#base_url').val() + "admin/ewallet/fund_transfer_post_agent",
        type: 'POST',
        data: form.serialize(),
        dataType: 'json',
        beforeSend: function() {
...
function loadEwalletSummaryTotal() {
    $.ajax({
        url: $('#base_url').val() + "admin/ewallet/summary_total_agent",
        type: 'GET',
        dataType: 'json',
        success: function (response) {
