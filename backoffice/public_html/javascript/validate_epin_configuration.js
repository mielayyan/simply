...
var ValidateEpinConfiguration = function() {
    ...
    var runValidatePinConfig = function() {
        ...
        $('#pin_config_form').validate({
            ...
            messages: {
                pin_maxcount: {
                    required: trans('required',trans('maximun_active_e_pin')),
                    min: trans('field_greater_than_zero',trans('maximun_active_e_pin')),
                    digits: trans('digits'),
                    maxlength: trans('maxlength_digits',trans('maximun_active_e_pin'), "10")
                },
            },
    ...
    var runValidatePinConfigAmount = function() {
        ...
        $('#epin_amount').validate({
            ...
            messages: {
                pin_amount: {
                    required: trans('required',trans('epin_amount')),
                    number: trans('digits'),
