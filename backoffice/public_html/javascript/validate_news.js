...
var ValidateUploadNews = function() {
	...
	$('#upload_news').validate({
	    ...
	    messages: {
		news_title: {
                    required: trans('required',trans('news_title')),
                    maxlength:trans('maxlength',trans('news_title'),"250")
                },
		news_desc: {
                    required: trans('required',trans('news_desc')),
                    //maxlength:trans('maxlength',trans('news_desc'),"200")
                }
...
var ValidateMaterialsUpload = function() {
	...
	$('#upload_materials').validate({
	    ...
	    messages: {
		file_title: {
                required: trans('required',trans('File_Title')),
                maxlength:trans('maxlength',trans('File_Title'),"50")
                },
		file_desc: {
                    required: trans('required',trans('file_desc')),
                    maxlength:trans('maxlength',trans('file_desc'),"200")
                },
		upload_doc: {required:trans('required_select',trans('file'))}  
	    },
	    invalidHandler: function(event, validator) { //display error alert on form submit
		errorHandler1.show();
	    },
