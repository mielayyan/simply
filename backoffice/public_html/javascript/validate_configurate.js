...
//                },
            ...
            messages: {
                co_name: {
                      ...
                      required:trans('required',trans('company_name')),
                      maxlength:trans('maxlength',trans('company_name'),"250")

                },
                company_address: {
                    required: trans('required',trans('company_address')),
                    minlength: trans('minlength',trans('company_address'),"1"),
                    maxlength: trans('maxlength',trans('company_address'),"1000")
                },
//               favicon: msg2,
//                img_logo: msg4,
                email:
                        {
                            ...
                            email: trans('valid_email',trans('email')),
                            maxlength:trans('maxlength',trans('email'),"250")
                        },
                lead_url:
                        {
                            required: msg5,
                ...
                phone: {
                    ...
                    //jQuery.format(msg21),
                    maxlength: trans('maxlength',trans('phone'),'50'),
                    //jQuery.format(msg18),
                }
    ...
    var runValidateLinkConfig = function () {
        ...
        $('#link_config').validate({
            ...
            messages: {
                fb_link: {
                    required: trans('required',trans('facebook')),
                    facebook_check: trans('valid_url'),
                },
                twitter_link: {
                     required: trans('required',trans('twitter')),
                    twitter_check: trans('valid_url')
                },
                inst_link: {
                     required: trans('required',trans('instagram')),
                    insta_check: trans('valid_url'),
                },
                gplus_link: {
                     required: msg29,
                    google_check: msg17,
