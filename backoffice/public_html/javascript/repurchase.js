...
function validate_pwallet() {
    ...
    disable_pwallet();
     if(ewallet_username == "" || ewallet_password == "") {
        if(ewallet_username == "") {
            $("#uname_pwallet_box").fadeTo("fast", 1, function() //start fading the messagebox
            {
             ...
             $.ajax({
                ...
                'type': "POST",
                'data': {
                    username: $('#uname_pwallet').val(),
                },
                success: function(data) {
                    $('#uname_pwallet_box').show();
                    $usernameusing=$('#uname_pwallet').val();
                    if($usernameusing!="")
                    {
                    if(data=='no')
                    {
                       $("#uname_pwallet_box").fadeTo("fast", 1, function() {
