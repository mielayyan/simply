    ...
    var runValidatorweeklySelection = function() {
        ...
        $('#lead_register').validate({
            ...
            messages: {
                ...
                mobile_no: {
                    digits: trans('digits'),
                    minlength: trans('minlength_digits',trans('mobile_no'),"5"),
                    maxlength:trans('maxlength_digits',trans('mobile_no'),"30"),
                },
                description: {
		    
                    maxlength:trans('maxlength',trans('description'),"1000")
		           },
                followup_date:{
                    required:trans('required_select',trans('next_follow-up_date')),
                    greater_than_today: trans('valid_date')
                }
            },
