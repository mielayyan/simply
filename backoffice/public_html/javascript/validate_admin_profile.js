var ValidateUser = function() {
	...
	$('#searchform').validate({
	    ...
	    messages: {               
                 user_name: {
                    ...
                    username_check:trans('invalid_username')
                }
	    },
            onkeyup: false,
	...
	$('#searchform1').validate({
	    ...
	    messages: {
		count: {
                    required: trans('required',trans('count')),
		    digits: trans('digits'),
                    }
	...
	$('#from_to_form').validate({
	    ...
	    messages: {
		count_from: {
                    required: trans('required',trans('count_from')),
		    number: trans('digits'),
                    },
		count_to: {
                    required: trans('required',trans('count_to')),
		    number: trans('digits'),
