function addNewStatus()
{
    ...
    var new_status = "<tr><td></td><td> <input type='text' name='status_name' id='status_name'   class='form-control' />";
    new_status += "</td>";
...
function addNewTag()
{
    ...
    var new_status = "<tr><td></td><td> <input type='text' name='tag_name' id='tag_name'   class='form-control' />";
    new_status += "</td>";
...
function addNewPriority()
{
    ...
    var new_status = "<tr><td></td><td> <input type='text' name='priority_name' id='priority_name'   class='form-control' />";
    new_status += "</td>";
...
//               }
            ...
            messages: {
                name: {
                    ...
                    maxlength: trans('maxlength',trans('category_name'),"40")
                }
...
var ValidatePriority = function () {
    ...
    var Validatepririty = function () {
        ...
        $('#new_priority').validate({
            ...
            messages: {
                priority_name: {
                    required: trans('required',trans('priority_name')),
                    maxlength: trans('maxlength',trans('priority_name'),"40"),
                }
            },
            invalidHandler: function (event, validator) { //display error alert on form submit
                errorHandler1.show();
...
var ValidateStatus = function () {
    ...
    var Validatestatus = function () {
        ...
        $('#new_status').validate({
            ...
            messages: {
                status_name: {
                    required: trans('required',trans('status_name')),
                    maxlength: trans('maxlength',trans('status_name'),"40"),
                }
            },
            invalidHandler: function (event, validator) { //display error alert on form submit
                errorHandler1.show();
...
var ValidateTag = function () {
    ...
    var Validatetag = function () {
        ...
        $('#new_tag').validate({
            ...
            messages: {
                tag_name: {
                    required: trans('required',trans("tag_name")),
                    maxlength: trans('maxlength',trans('tag_name'),"40"),
                }
            },
            invalidHandler: function (event, validator) { //display error alert on form submit
                errorHandler1.show();
