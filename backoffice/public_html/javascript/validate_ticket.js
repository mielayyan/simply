...
var ValidateTicket = function () {
    ...
    var runValidatorUserSelection = function () {
        ...
        $('#create_ticket').validate({
            ...
            messages: {
                subject: {maxlength:trans('maxlength',trans('subject'),250)},
                priority: {required: trans('required_select',trans('priority'))},
                category: {required: trans('required_select',trans('category'))},
                message: {maxlength:trans('maxlength',trans('message'),1000)}
