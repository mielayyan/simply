...
var ValidateMail = function () {
    ...
    var runValidateFundSelection = function () {
        ...
        jQuery.validator.addMethod('checkMailContent', function (mailContent) {
            mailContent = mailContent.replaceAll(/(<([^>]+)>)/ig, "");
            mailContent = mailContent.replaceAll('&nbsp;', ' ');
            mailContent = mailContent.trim();
            return (mailContent.length > 0);
        }, "");
        ...
        $('#compose').validate({
            ...
            rules: {
                ...
                message1: {
                    required: true,
                    checkMailContent: true

                }
            },
            messages: {
                message1: {
                    required: trans('required', trans('message')),
                    checkMailContent: trans('required', trans('message'))
                }
            },
