var ValidateUser = function() {
    var runValidatorweeklySelection = function() {
        ...
        $('#add_addrdess').validate({
            ...
            messages: {
                full_name: {
                    required:trans('required',trans('name')),
                    
                    maxlength:trans('maxlength',trans('name'),"250")
                },
                address: {
                    required: trans('required',trans('address')),
                    maxlength:trans('maxlength',trans('address'),"1000")
                },
                pin_no: {
                    required: trans('required',trans('pin')),
                    
                    maxlength:trans('maxlength',trans('pin'),"30"),
                    minlength:trans('minlength',trans('pin'),"3")
                },
                city: {
                    required: trans('required',trans('city')),
                    alpha_city: trans('alpha_space',trans('city')),
                    maxlength:trans('maxlength',trans('city'),"250")
                },
                phone: {
                    
                    required:trans('required',trans('phone')) ,
    ...
    var runValidatorEwallet = function() {
        ...
        $('#form').validate({
            ...
            messages: {
                user_name_ewallet: {
                    required: trans('required',trans('username')),
                },
                tran_pass_ewallet: {
                    required: trans('required',trans('trans_passwd')),
                }
            },
            invalidHandler: function(event, validator) {
                errorHandler1.show();
...
$(function() {
    ...
    function dupilcate_span(i) {
        ...
        if (i) {
            var id = 'id =repurchase_pin_invalid' + i;
            var dupilcate_span = '<span ' + id + ' ><i style="color: red;" class="fa fa-times-circle"></i>&nbsp;please enter E-Pin</span>';
        } else {
            var dupilcate_span = '<span id="repurchase_pin_invalid"><i style="color: red;" class="fa fa-times-circle"></i>&nbsp;please enter E-Pin</span>';
        }
