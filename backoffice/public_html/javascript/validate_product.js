...
var ValidateProduct = function() {
    ...
    var runValidateProduct = function() {
    	...
    	$('#form').validate({
    		...
    		messages: {
    			prod_name: {
                    required: trans('required',trans('product_name')),
                    maxlength:trans('maxlength',trans('product_name'),"250")
                },
    			product_id: trans('required',trans('product_id')),
    			product_amount: {
                    required: trans('required',trans('product_amount')),
                    greaterThanNum: trans('field_greater_than_zero',trans('product_amount')),
                    number:trans('digits'),
                    maxlength: trans('max_digits',trans('product_amount'),"30")
                },
    			pair_value: {
                    required: trans('required',trans('pair_value')),
                    digits: trans('digits'),
                    maxlength: trans('max_digits',trans('pair_value'),"30")
                },
    			pair_price: {
                    required: msg11,
                    min: msg9,
    			...
    			package_id: { 
                    required: trans('required',trans('package_id')),
                    alpha_num:trans("only_alphabets_numerals")
                },
    			package_validity: {
    				required: trans('required',trans('package_validity')),
    				digits: trans('digits'),
                    maxlength: trans('max_digits',trans('package_validity'),"30")
    			},
                referral_commission: {
                    required: msg12,
                    digits: msg21,
                ...
                category:{
                    ...
                    required:trans('required_select',trans('category')),
                },
                rank_name: {
                    required: msg30
                },
...
var ValidateCategory = function() {
    ...
    var runValidateCategory = function() {
    	...
    	$('#category_form').validate({
    		...
    		messages: {
    			category_name: {
                            required: trans('required',trans('category_name')),
                            maxlength:trans('maxlength',trans('category_name'),"250")
    			}
                },
    		invalidHandler: function(event, validator) { 
    			errorHandler1.show();
