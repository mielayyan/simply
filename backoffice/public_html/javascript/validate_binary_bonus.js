...
var ValidateConfiguration = function () {
    var runValidateConfiguration = function () {
        ...
        $('#form_setting').validate({
            ...
            messages: {
                point_value: {
                    required: trans('required', pnt_val.toLowerCase()),
                    // required: msg26.replace('%s', pnt_val.toLowerCase())
                },
                pair_value: {
                    required: trans('required',pr_val.toLowerCase()),
                    // required: msg26.replace('%s', pr_val.toLowerCase()),
                    greaterThanNum: msg30
                },
                flush_out_limit: {
                    required: trans('required',fl_lmt.toLowerCase()),
        ...
        $('.pair-commission').each(function () {
            $(this).rules('add', {
                required: true,
                messages: {
                    required: trans('required',pr_comm.toLowerCase()),
