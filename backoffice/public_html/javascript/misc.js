...
function view_user_earnings(id, from, root) {
    document.location.href = root + 'ewallet?tab=user_earnigs_tab&user_name=' + id;
    // window.open(root + 'ewallet?tab=user_earnigs_tab&user_name=' + id,'_blank');
}