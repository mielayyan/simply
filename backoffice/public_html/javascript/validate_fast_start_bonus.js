...
$(function () {
    $('input[name="fast_start_referral_count"],input[name="fast_start_days"],input[name="fast_start_bonus"]').attr('maxlength', 10);
...
var ValidateConfiguration = function () {
    var runValidateConfiguration = function () {
        ...
        $('#form_setting').validate({
            ...
            messages: {
                fast_start_referral_count: {
                    required: trans('required',referral_count),
                    // required: msg26.replace('%s', referral_count),
                    digits: msg30,
                    min: msg30,
                },
                fast_start_days: {
                    required: trans('required',days),
                    // required: msg26.replace('%s', days),
                    digits: msg30,
                    min: msg30,
                },
                fast_start_bonus: {
                    required: trans('required',bonus_amount),
