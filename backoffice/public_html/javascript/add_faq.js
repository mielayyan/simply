...
$('#faq').validate({
    ...
    messages: {
        question: {
            required: trans('required',trans('question')),
            maxlength:trans('maxlength',trans('question'),"250")
        },
        answer: {
            required: trans('required',trans('answer')),
            maxlength:trans('maxlength',trans('answer'),"1000")
        },
        sort_order: {
            required: trans('required',trans('sort_order')),
            maxlength:trans('maxlength_digits',trans('sort_order'),"50"),
            greaterThanNum: trans('field_greater_than_zero',trans('sort_order'))
        }
    },
