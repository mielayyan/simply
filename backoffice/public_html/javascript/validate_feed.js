...
//                    time24:true
            ...
            messages: {
                ...
                company: {
                    ...
                    minlength: trans('minlength',trans('company'),"3"),
                    maxlength: trans('maxlength',trans('company'),"250")
                },
                phone_no: {
                    phone_number:trans('digits'),
                    minlength: trans('minlength',trans('phone_no'),"5"),
                    maxlength: trans('maxlength',trans('phone_no'),"30"),
                },
                time_to_call: {
                    required:trans('required_select',trans('time_to_call'))
